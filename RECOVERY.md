...
| Файл | Что это |
|---|---|
| `scoresbox-2026-09-04-dockerfix.git-bundle` (~0,5 МБ) | ✅ **ГЛАВНЫЙ**: весь проект одним коммитом, применяется в ЛЮБОМ репозитории (даже после reinit). Дата в имени — маркер актуальности. Если была ошибка «prerequisite commits» — использовать его |
...
git log --oneline -1 FETCH_HEAD          # проверка: «SCORESBOX 2026-09-04…» (НЕ «v1.0.4» / без даты!)
...
> свежий бандл с датой в имени (например scoresbox-2026-09-04-dockerfix.git-bundle)
