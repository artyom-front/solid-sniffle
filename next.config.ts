...
const nextConfig: NextConfig = {
  ...
  // SECURITY/QUALITY: ошибки TypeScript обязаны ломать сборку. Раньше
  // ignoreBuildErrors:true пропускал сломанные типы в Docker и прод.
  ...
  async headers() {
    return [
      ...
      {
        // медиатека — immutable (кэш на год, id уникален навсегда); правило после /api/:path*
