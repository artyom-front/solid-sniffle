...
const PLACEMENTS: { code: string; label: string; size: string }[] = [
  ...
  // v1.0.29: колонки поменялись — слева список лиг, справа статистика/таблица
  { code: "LEFT_TOP", label: "Колонка слева · верх (над списком лиг)", size: "300×250" },
  { code: "LEFT_BOTTOM", label: "Колонка слева · низ (под списком лиг)", size: "300×250" },
  { code: "RIGHT_TOP", label: "Колонка справа · верх (статистика и таблица)", size: "260×250" },
  { code: "RIGHT_BOTTOM", label: "Колонка справа · низ (под виджетами)", size: "260×250" },
