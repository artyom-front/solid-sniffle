...
interface StadiumDetail {
  stadium: { id: string; name: string; city: string | null; address: string | null; capacity: number | null; photoUrl?: string | null };
    ...
    <div className="space-y-3">
      ...
      <div className="overflow-hidden rounded-2xl border border-sline bg-s1">
        {stadium.photoUrl ? (
          ...
          <img src={stadium.photoUrl} alt={`${stadium.name} — фото арены`} className="h-40 w-full object-cover sm:h-52" />
        ) : null}
