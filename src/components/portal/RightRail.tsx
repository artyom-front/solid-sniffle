 ...
 *  и сдвигов вёрстки); с картинкой — имиджевый баннер. */
  ...
  if (banner.imageUrl) {
    return (
      ...
      >
        ...
        <span className="absolute bottom-2 right-2 z-10 rounded-md bg-s0/80 px-2 py-0.5 text-xs font-bold text-gold backdrop-blur">Реклама</span>
      </a>
    );
  }
  return (
