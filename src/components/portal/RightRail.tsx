...
// Правая колонка «Ночь под прожекторами» (v1.0.20): баннеры, «Матч тура» /
// «Прямо сейчас», «Самый результативный» и топ игроков.
// layout="rail"  — вертикальная колонка (классический режим).
// layout="grid"  — витрина под лентой на главной (сайт теперь колонкой
//                  800px): карточки в сетке 2 колонки, топ игроков — на всю ширину.
...
export default function RightRail({ overview, banners, version, layout = "rail" }: Props) {
