...
//  • Составы (ProtocolLineupTab, v1.0.28): старт → номера →
//    запас → штат; номера на матч с запретом дублей.
...
import { ArrowLeft, Ban, CheckCircle2, RotateCcw, Trash2, Info, FileText, Loader2, Upload, Plus, X, Flag, ArrowDown, ArrowUp } from "lucide-react";
...
export default function ProtocolEditor({ matchId, user, onBack, bump }: Props) {
  ...
  // форма состава (v1.0.28) — целиком в ProtocolLineupTab: старт → № → запас → штат
  ...
  return (
    <div className="space-y-4">
      ...
      {/* ---------- Составы (v1.0.28: старт → № → запас → штат) ---------- */}
      {tab === "lineup" && !isLocked && (
