                ...
                <CardContent className="space-y-2">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <Button
                      ...
                      onClick={() => setLineupOverrides((s) => ({ ...s, [side]: new Set<string>() }))}
                    >
                      <X className="mr-1 h-3 w-3 text-zinc-400" /> Снять
                    </Button>
                    <span className="ml-auto text-xs text-zinc-400">{selected.size} / {players.length}</span>
                  </div>
        ...
        <Card className="border-zinc-200">
          ...
          <CardContent className="space-y-3">
            <p className="text-xs text-zinc-500">
              ...
              «✕» — убрать лишнюю. Нейтральные лица не могут быть заявлены за команды-участницы.
            </p>
