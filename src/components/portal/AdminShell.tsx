...
export default function AdminShell({ user, version, bump, onReload, focusMatchId, onMatchHandled }: Props) {
  ...
  const renderSection = () => {
    ...
    switch (section) {
      ...
      case "teams":
        return <ClubsTeamsPanel bump={bump} onReload={onReload} version={version} />;
      case "people":
        return <PeoplePanel bump={bump} onReload={onReload} version={version} />;
      case "stadiums":
      ...
      case "registrations":
        return <RegistrationsPanel seasonId={effectiveSeasonId} bump={bump} version={version} />;
      case "import":
