...
import { normalizeRoles, refereeFromRoles, cardRoleConflict, CARD_ROLE_CONFLICT_HINT, REFEREE_CONFLICT_CODES, roleName } from "@/lib/roles";
...
async function importRow(
  ...
  if (person) {
    ...
    const incomingRoles =
      entity === "players" && person.roles.some((c) => REFEREE_CONFLICT_CODES.includes(c))
